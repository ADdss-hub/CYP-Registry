...
export const projectApi = {
  ...
  getProjects: (params?: { page?: number; pageSize?: number; keyword?: string; isPublic?: boolean }) =>
    api.get<PaginatedResponse<Project>>('/v1/projects', params) as Promise<PaginatedResponse<Project>>,

  getProject: (id: string) =>
    api.get<Project>(`/v1/projects/${id}`) as Promise<Project>,

  createProject: (data: CreateProjectRequest) =>
    api.post<{ project: Project }>('/v1/projects', mapCreateProjectPayload(data)) as Promise<{ project: Project }>,

  updateProject: (id: string, data: UpdateProjectRequest) =>
    api.put<Project>(`/v1/projects/${id}`, mapUpdateProjectPayload(data)) as Promise<Project>,
