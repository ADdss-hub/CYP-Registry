      ...
      <div v-if="isVisible" class="cyp-dialog__mask" @click="handleMaskClick">
        ...
        >
          <div class="cyp-dialog__header">
            <h3 v-if="title" class="cyp-dialog__title">{{ title }}</h3>
            <button
              v-if="closable"
          ...
          <div v-if="footer" class="cyp-dialog__footer">
            <slot name="footer">
              <button class="cyp-dialog__btn cyp-dialog__btn--default" @click="handleClose">
                取消
              </button>
              <button class="cyp-dialog__btn cyp-dialog__btn--primary" @click="handleClose">
                确定
              </button>
            </slot>
          </div>
